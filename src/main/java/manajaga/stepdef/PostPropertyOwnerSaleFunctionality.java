...
public class PostPropertyOwnerSaleFunctionality {
	...
	public void enter_All_the_Mandatory_fields_for_Property_type_of_post_property_for_Sale(String Propertytype) throws Throwable {
		if (Propertytype.contains("Agriculture Land")) 
		{
			...
			BaseTest.driver.findElement(manajaga_elements.videoURL).sendKeys("https://www.youtube.com/watch?v=0kudvXNCHGk");
			BaseTest.driver.findElement(manajaga_elements.PP_description).sendKeys("entered all the fields of Agriculture Land property");
			Thread.sleep(2000);
		...
		if(Propertytype.contains("Apartment")) 
		{
			...
			BaseTest.driver.findElement(manajaga_elements.videoURL).sendKeys("https://www.youtube.com/watch?v=0kudvXNCHGk");
			Thread.sleep(2000);
			BaseTest.driver.findElement(manajaga_elements.PP_description).sendKeys("entered all the fields of Apartment property");
			BaseTest.driver.findElement(manajaga_elements.nxtbtn_propertyinfo).click();
			Thread.sleep(60000);
			BaseTest.waitUntilPageLoad();
		...
		if(Propertytype.contains("Commercial Plot")) {
			...
			BaseTest.driver.findElement(manajaga_elements.videoURL).sendKeys("https://www.youtube.com/watch?v=wc9gePevueQ");
			BaseTest.driver.findElement(manajaga_elements.PP_description).sendKeys("Entered all the fields of Commercial Plot type");
			BaseTest.driver.findElement(manajaga_elements.nxtbtn_propertyinfo).click();
			Thread.sleep(60000);
			BaseTest.waitUntilPageLoad();
		...
		if(Propertytype.contains("Commercial Shop"))
		{
			...
			BaseTest.driver.findElement(manajaga_elements.PP_ResponseFromAll).click();
			BaseTest.driver.findElement(manajaga_elements.videoURL).sendKeys("https://www.youtube.com/watch?v=dQiYfH-C8lU");
			BaseTest.driver.findElement(manajaga_elements.PP_description).sendKeys("Entered all the fields of Commercial Shop property type");
			BaseTest.driver.findElement(manajaga_elements.nxtbtn_propertyinfo).click();
			Thread.sleep(60000);
			BaseTest.waitUntilPageLoad();
		...
		if(Propertytype.contains("Industrial Land"))
		{
			...
			BaseTest.driver.findElement(manajaga_elements.PP_ResponseFromAll).click();
			BaseTest.driver.findElement(manajaga_elements.videoURL).sendKeys("https://www.youtube.com/watch?v=CAEjVrj8Gaw");
			BaseTest.driver.findElement(manajaga_elements.PP_description).sendKeys("Entered all the fields of Industrial Land property type");
			BaseTest.driver.findElement(manajaga_elements.nxtbtn_propertyinfo).click();
			Thread.sleep(60000);
			BaseTest.waitUntilPageLoad();
		...
		if(Propertytype.contains("Individual House"))
		{
			...
			BaseTest.driver.findElement(manajaga_elements.videoURL).sendKeys("https://www.youtube.com/watch?v=6GvCTfX5i5s");
			BaseTest.driver.findElement(manajaga_elements.PP_description).sendKeys("Entered all the fields of Individual House property type");
			BaseTest.driver.findElement(manajaga_elements.nxtbtn_propertyinfo).click();
			Thread.sleep(60000);
			BaseTest.waitUntilPageLoad();
		...
		if(Propertytype.contains("Office Space"))
		{
			...
			BaseTest.driver.findElement(manajaga_elements.PP_ResponseFromAll).click();
			BaseTest.driver.findElement(manajaga_elements.videoURL).sendKeys("https://www.youtube.com/watch?v=mGV-qVkaD1g");
			BaseTest.driver.findElement(manajaga_elements.PP_description).sendKeys("Entered all the fields of Office Space Property type");
			BaseTest.driver.findElement(manajaga_elements.nxtbtn_propertyinfo).click();
			Thread.sleep(60000);
			BaseTest.waitUntilPageLoad();
		...
		if(Propertytype.contains("Pent House"))
		{
			...
			BaseTest.driver.findElement(manajaga_elements.PP_OnlyAgentsBrokers).click();
			BaseTest.driver.findElement(manajaga_elements.videoURL).sendKeys("https://www.youtube.com/watch?v=pbOdgwUN8mY");
			Thread.sleep(2000);
			BaseTest.driver.findElement(manajaga_elements.PP_description).sendKeys("entered all the fields of Pent House property");
			BaseTest.driver.findElement(manajaga_elements.nxtbtn_propertyinfo).click();
			Thread.sleep(60000);
			BaseTest.waitUntilPageLoad();
		...
		if(Propertytype.contains("Ware House"))
		{
			...
			BaseTest.driver.findElement(manajaga_elements.PP_OnlyAgentsBrokers).click();
			BaseTest.driver.findElement(manajaga_elements.videoURL).sendKeys("https://www.youtube.com/watch?v=L-4j9B43IV8");
			Thread.sleep(2000);
			BaseTest.driver.findElement(manajaga_elements.PP_description).sendKeys("entered all the fields of Ware House property");
			BaseTest.driver.findElement(manajaga_elements.nxtbtn_propertyinfo).click();
			Thread.sleep(60000);
			BaseTest.waitUntilPageLoad();
