...
public class PostPropertyPgValidation {
	...
	@When("^User Select Apartment Property type for Post Property PG$")
	public void User_Select_Apartment_Property_type_for_Post_Property_PG() throws Throwable
	{
		CommonMethods.SelectDD("propertyTypePG", "Apartment");
	}
	
	@When("^User Select Individual House Property type for Post Property PG$")
	public void User_Select_Individual_House_Property_type_for_Post_Property_PG() throws Throwable
	{
		CommonMethods.SelectDD("propertyTypePG", "Individual House");
	}
}
